    ...
    public function handle(IndesignTxtExportService $exportService): int
    {
        try {
            ...
            $result = [
                ...
                'prices_source' => $export['prices_source'],
                'price_requires_review' => $export['price_requires_review'],
                'price_review_count' => $export['price_review_count'],
                'price_warnings' => $export['price_warnings'],
